...
if [ "$CHENTRY" = "manual" ] ; then
	...
	MSSID=$(echo "enter the SSID and password of the network (SSID,password)" | rofi -dmenu -p "Manual Entry: " -font "$FONT" -lines 1 -a "$HIGHLINE" -location "$POSITION" -yoffset "$YOFF" -xoffset "$XOFF" -width 30)
